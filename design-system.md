...
| A2 | `projects/index.html` | `54d3a80143dc3231d9df6d401dddb39feb57edbafb5f5e32d3c99e1741c59254` |
| A3 | `build-log/index.html` | `68c8101f2f462a1354252b8c424321c4dfd52c773e244d1fd038dd6ea2c7da86` |
| A3 | `build-log/log.css` | `c08d968080b01381693c99384c3c5a09a8f5cbff27126f885072a8218b2762f5` |
| A4 | `exhibits/index.html` | `25d766c73525c0898539a36a984eb9737d253e3a1f12ca36b98cf71b953d33cc` |
...
- **MUST** be a single centered column with a reading-width cap below `64rem`. At `64rem` and wider the page widens and sections flow into columns (P7a). [`styles.css:34-37,158-197`, `projects/index.html:37,101`, `build-log/log.css:33,81-94`, `exhibits/index.html:36,87`] The paragraph cap stays `66ch` (P7).
...
| D10 | **Resolved 2026-09-26 (Patrick: "roll out").** A2 broke P7a: one 66ch column at every width. At `64rem` and wider the page now grows to `90rem` and the project list wraps into a `minmax(28rem, 1fr)` grid (2 columns from 1024px to 1920px). Appended to the existing `.sig` line, so no line numbers moved. | `projects/index.html:37,101` |
| D11 | **Resolved 2026-09-26 (Patrick: "roll out").** A3 broke P7a: one 66ch column at every width. At `64rem` and wider the page now grows to `90rem` and the issue list wraps into a `minmax(22rem, 1fr)` grid (3 columns at 1920px, 2 at 1024px). Added as a block at the end of the stylesheet. | `build-log/log.css:33,81-94` |
